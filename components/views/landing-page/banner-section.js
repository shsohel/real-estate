...
const BannerSection = () => {
  return (
    ...
    >
      <div className="animate__animated animate__zoomIn animate-delay-2s mt-20 md:mt-0">
        <div >
          <p className="text-[22px] font-medium text-center mb-8 tracking-widest">
            LET US GUIDE YOUR HOME
          </p>
          <h2 className=" text-5xl md:text-7xl font-medium text-center mb-sm-13 mb-8 tracking-widest">
